(ns project-euler.poker-hands-input)

(def small-input ["AS KS QS JS TS TD 9D 8D 7D 6D"
                  "AD AS AH AC 2D KD KS KH QD QS"
                  "2D 4D 6D 8D TD 2S 3D 4S 5D 6S"
                  "AD AS AC 4D 6D QD QS KD KS 9H"
                  "AD AS 3C 5D 9H AC 3H 5S 4C 9D"])

(def full-input ["8C TS KC 9H 4S 7D 2S 5D 3S AC"
